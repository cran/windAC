...
#' \describe{
#'   \item{study}{The name of the study for that wind farm.}
#' \item{distanceFromTurbine}{The distance (meters) from the turbine for the outer radius of a one meter ring or annulus. Distances start at 3m to accommodate a 2m-radius turbine mast.}
...
#' \item{finalWeight}{The product of \code{detectionProbability*proportionAreaSearched*scaledNumberTurbine*scaledFatalityRate}.}
#' }
#'
#'
#'
